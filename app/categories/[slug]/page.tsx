...
import { CategoryNameType, ResourceCardType } from "@/sanity/lib/types";
...
export default async function CategoryPage({
  ...
  const getResourcesQuery = groq`*[_type == "resource" && references(*[_type == "category" && slug.current == "${
    params.slug
  }"]._id)] | order(${sortOrder}) [${(pageNum - 1) * pageSize}...${
    pageNum * pageSize
  }] {
      _id,
      _createdAt,
